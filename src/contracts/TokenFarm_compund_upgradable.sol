// pragma solidity ^0.8.0;  //need to change to 0.6.0 in order to use upgradable contract function
...
// contract TokenFarm_upgradable is Initializable{
//     string public name;
...
//     uint256 internal tokenBurnRate;
//     uint256 public constant duration;
//     uint256 public constant penaltyRate;
//     uint256 public decimalFlow;
...
//             uint256 amount = (farmInfo.blockReward * balance) /
//                 farmInfo.farmableSupply;
...
//                 address recipient = stakers[i];
//                 uint256 balance = stakerInfo[recipient].stakingBalance;
//                 uint256 ratio = (balance * 100 * decimalFlow) /
//                     farmInfo.farmableSupply;
...
//         stakerInfo[_to].stakingTimestamp = stakerInfo[msg.sender]
//         .stakingTimestamp;
...
//     function initialize(XToken _xToken, LPXToken _lpXToken, PurseToken _purseToken, uint256 _blockReward) public initializer {   //Act as constructor
